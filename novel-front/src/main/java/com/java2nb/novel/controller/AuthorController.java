...
public class AuthorController extends BaseController{
    ...
    public ResultBean updateBook(@RequestParam("bookDesc") String bookDesc,Book book,HttpServletRequest request){

        Author author = checkAuthor(request);

        //更新发说
        bookService.updateBook(book,author.getId(),author.getPenName());
    ...
    public ResultBean deleteBook(@PathVariable("id") Long id,HttpServletRequest request){
        Author author = checkAuthor(request);
        //删除发说
        bookService.deleteBook(id,author.getId(),author.getPenName());
        return ResultBean.ok();
    }

var BookDetail = {
    ...
    AddFavorites: function (BId, CId, layerStatus) {
        $.ajax({
            ...
            success: function (data) {
                if (data.code == 200) {
                    if (layerStatus == 1) {
                        $("#cFavs").html("<a class=\"ico_shelf\" href=\"javascript:void(0);\"><b>已订阅</b></a>");
                        jQuery.cookie("u-faorites", "1");
                    }
                    else {
                        $("#cFavs").html("<a class=\"btn_ora_white btn_addsj\" href=\"javascript:void(0);\">已订阅</a>");
                    }
    ...
    DeleteComment: function (cmtCId) {
        $.ajax({
            type: "POST",
            url: "/book/deleteBookComment",
            data: {'commentId': cmtCId},
            dataType: "json",
            success: function (data) {
                if (data.code == 200) {
                    // $('#txtComment').val("")
